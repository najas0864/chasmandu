...
const ForgetPass = () => {
    ...
    const getOtp = async () => {
        ...
        try {
            const otpResponse = await axios.post(`/api/forget-password`,{email});
    ...
    const handleOtpVerification = async () => {
        try {
            const otpResponse = await axios.post(`/api/auth/verify-otp`,{otp});
    ...
    const handlePswReset =async () => {
        ...
        try {
            const res = await axios.post(`/api/update-password`,{password,rePassword,email},{
